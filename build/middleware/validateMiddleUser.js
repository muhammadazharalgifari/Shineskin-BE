...
exports.validateMiddleUser = validateMiddleUser;
...
function validateMiddleUser() {
  return _validateMiddleUser.apply(this, arguments);
}
function _validateMiddleUser() {
  _validateMiddleUser = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var req,
      res,
      next,
      authHeader,
