...
function _deleteProduct() {
  _deleteProduct = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var req,
      res,
      id,
      productId,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 12:
          ...
          imagePath = _path["default"].join(__dirname, "../../../public/imageProducts"); // Ganti dengan path yang sesuai
          filepath = imagePath + "/" + findProduct.imageProduct; // Hapus local file
          ...
          _context.next = 17;
          return _connector["default"].products["delete"]({
            where: {
              id: productId
            }
          });
