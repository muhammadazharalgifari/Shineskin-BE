...
function _getProductById() {
  _getProductById = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var req,
      res,
      id,
      productId,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 2;
          id = req.params.id;
          productId = parseInt(id); // validasi data param categoryId harus int
          if (!isNaN(productId)) {
            _context.next = 7;
            break;
          }
        ...
        case 7:
          _context.next = 9;
          return _connector["default"].products.findMany({
            where: {
              id: productId
            },
            select: {
