...
function _getProductsByCategory() {
  _getProductsByCategory = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var req,
      res,
      category,
      categoryId,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          categoryId = parseInt(category); // validasi data param categoryId harus int
          if (!isNaN(categoryId)) {
            _context.next = 7;
            break;
          }
        ...
        case 7:
          _context.next = 9;
          return _connector["default"].categories.findMany({
            where: {
              id: categoryId
            },
            select: {
        ...
        case 12:
          ...
          categoryData = _response[0];
          if (!(categoryData.products.length === 0)) {
            _context.next = 15;
            break;
          }
          return _context.abrupt("return", res.status(404).json({
            status: "Founded category ".concat(categoryData.name),
