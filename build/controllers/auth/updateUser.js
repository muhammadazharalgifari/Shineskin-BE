...
exports.uploadUpdate = exports.updateUser = void 0;
...
var uploadDir = _path["default"].join(__dirname, "../../../public/imageProfile");
...
var storage = _multer["default"].diskStorage({
  ...
  filename: function filename(req, file, cb) {
    ...
    var randomDataProfile = email.replace(/[^a-zA-Z0-9]/g, "_");
    cb(null, randomDataProfile + _path["default"].extname(file.originalname));
  }
});
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 7;
          return _connector["default"].users.findUnique({
            where: {
              id: userId
            }
          });
        ...
        case 10:
          imageProfilePath = user.imageProfile;
          if (req.file) {
            // hapus foto lama
            imagePath = _path["default"].resolve(__dirname, "../../../public/imageProfile", user.imageProfile);
        ...
        case 23:
          _context.next = 25;
          return _connector["default"].users.update({
            where: {
              id: req.userId
            },
            data: {
