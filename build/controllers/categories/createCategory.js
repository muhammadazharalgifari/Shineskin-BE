...
var uploadDir = _path["default"].resolve(__dirname, "../../../public/imageCategory");
...
function _createCategory() {
  _createCategory = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var req,
      res,
      _req$body,
      name,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          _context.next = 8;
          return _connector["default"].categories.findFirst({
            where: {
              name: name
            }
          });
        ...
        case 11:
          _context.next = 13;
          return _connector["default"].categories.create({
            data: {
              name: name,
