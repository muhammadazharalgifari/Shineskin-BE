...
function updateCartItemById() {
  return _updateCartItemById.apply(this, arguments);
}
function _updateCartItemById() {
  _updateCartItemById = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var req,
      res,
      userId,
      id,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          _context.next = 11;
          return _connector["default"].cartItems.findUnique({
            where: {
              id: cartItemId
            },
            include: {
        ...
        case 14:
          ...
          productPrice = cartItem.product.price; // Menghitung subtotal_price yang baru
          subtotalPrice = productPrice * quantity;
          _context.next = 18;
          return _connector["default"].cartItems.update({
            where: {
              id: cartItemId
            },
            data: {
        ...
        case 18:
          ...
          return _context.abrupt("return", res.status(404).json({
            status: "error",
            message: "Cart item with ID ".concat(id, " not found")
          }));
        case 21:
          _context.next = 23;
